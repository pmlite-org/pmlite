...
export class TaskEntity {
  ...
  @Column({ type: 'varchar', nullable: true, name: 'task_id' })
  @AutoMap()
  taskId?: string | null;

  @Column({ type: 'varchar', nullable: true, name: 'team' })
  @AutoMap()
  team?: string | null;

  @Column({ type: 'varchar', nullable: true, name: 'epic_id' })
  @AutoMap()
  epicId?: string | null;
  ...
  @Column({ type: 'varchar', nullable: true, name: 'task_type' })
  @AutoMap()
  ...
  @Column({ type: 'varchar', nullable: true, name: 'priority' })
  @AutoMap()
  ...
  @Column({ type: 'timestamptz', nullable: true, name: 'actual_start_date' })
  @AutoMap()
  actualStartDate?: Date | null;

  @Column({ type: 'timestamptz', nullable: true, name: 'actual_end_date' })
  @AutoMap()
  ...
  @Column({ type: 'varchar', nullable: true, name: 'blocked_by' })
  @AutoMap()
